...
exports.encrypt = function(key, plain) { return Tea.encrypt(plain, key); }
exports.decrypt = function(key, cipher) { return Tea.decrypt(cipher, key); }
exports.checksum = Sha256.hash;